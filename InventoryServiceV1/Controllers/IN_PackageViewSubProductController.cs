...
{
    public class IN_PackageViewSubProductController : ApiController
    {
        private InventoryDBEntities db = new InventoryDBEntities();

        // GET: api/IN_PackageViewSubProduct
        public IQueryable<IN_Package> GetIN_Package()
        {
            return db.IN_Package;
        }

        // GET: api/IN_PackageViewSubProduct/5

        public HttpResponseMessage GetIN_Package(int id)
        {

            return Request.CreateResponse(HttpStatusCode.OK,
         db.IN_Package.Where(e => e.ProductID == id).ToList());



        }

        // PUT: api/IN_PackageViewSubProduct/5
        ...
        // POST: api/IN_PackageViewSubProduct
        ...
        // DELETE: api/IN_PackageViewSubProduct/5
        [ResponseType(typeof(IN_Package))]
