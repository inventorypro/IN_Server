...
{
    public class IN_ReceiverCheckAmountController : ApiController
    {
        private InventoryDBEntities db = new InventoryDBEntities();

        // GET: api/IN_ReceiverCheckAmount
        public IQueryable<IN_Receiver> GetIN_Receiver()
        {
            return db.IN_Receiver;
        }

        // GET: api/IN_ReceiverCheckAmount/5
        [BasicAuthentication]
        public HttpResponseMessage GetIN_ReceiverProductID(int id)
        {
         ...
         db.IN_Receiver.Where(e => e.ProductID == id && e.ESSUSR_Name == username && e.Status == "pending").ToList());



        }

        // PUT: api/IN_ReceiverCheckAmount/5
        ...
        // POST: api/IN_ReceiverCheckAmount
        ...
        // DELETE: api/IN_ReceiverCheckAmount/5
        [ResponseType(typeof(IN_Receiver))]
