...
{
    public class IN_ProductLocationController : ApiController
    {
        private InventoryDBEntities db = new InventoryDBEntities();

        // GET: api/IN_ProductLocation
        public IQueryable<IN_ProductLocation> GetIN_ProductLocation()
        {
            return db.IN_ProductLocation;
        }

        // GET: api/IN_ProductLocation/5
        [ResponseType(typeof(IN_ProductLocation))]
        public IHttpActionResult GetIN_ProductLocation(int id)
        {
        ...
        // DELETE: api/IN_ProductLocation/5
        [ResponseType(typeof(IN_ProductLocation))]
